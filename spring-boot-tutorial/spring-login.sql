...
ADD PRIMARY KEY
(`id`),
ADD UNIQUE KEY `UK_ofx66keruapi6vyqpv6f2or37`
(`name`);
...
ADD PRIMARY KEY
(`id`),
ADD UNIQUE KEY `UK_6dotkott2kjsp8vw4d0m25fb7`
(`email`),
ADD UNIQUE KEY `UK_r43af9ap4edm43mmtq01oddj6`
(`username`);
...
ADD PRIMARY KEY
(`user_id`,`role_id`),
ADD KEY `FKt7e7djp752sqn6w22i6ocqy6q`
(`role_id`);
...
ADD PRIMARY KEY
(`id`),
ADD UNIQUE KEY `UK_eyndd23d0p6qx0t07slpf4u0m`
(`token`) USING HASH,
ADD KEY `FKlfnsu4aqayvf0pn7f53wbs64b`
(`account_id`);
...
ALTER TABLE `roles`
  MODIFY `id` bigint
(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `user_role`
ADD CONSTRAINT `FKj345gk1bovqvfame88rcx7yyx` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`id`),
ADD CONSTRAINT `FKt7e7djp752sqn6w22i6ocqy6q` FOREIGN KEY
...
--
ALTER TABLE `verify_account`
ADD CONSTRAINT `FKlfnsu4aqayvf0pn7f53wbs64b` FOREIGN KEY
